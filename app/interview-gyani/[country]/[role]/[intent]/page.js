...
import { generateContent } from '../../../../lib/interview-gyani/contentGen';
import InterviewSEOContent from '../../../../components/interview-gyani/InterviewSEOContent';
import { COUNTRIES, ROLES, INTENTS } from '../../../../lib/interview-gyani/data';
...
export async function generateMetadata({ params }) {
    ...
    return {
        ...
        alternates: {
            canonical: `https://expertresume.us/interview-gyani/${country}/${role}/${intent}`
        },
        openGraph: {
            title: data.metadata.title,
            description: data.metadata.description,
