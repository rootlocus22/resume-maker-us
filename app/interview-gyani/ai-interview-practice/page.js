...
export default function AIInterviewPracticePage() {
    const content = {
        ...
        solutionDescription: "InterviewGyani provides a safe, judgment-free zone to practice. If you stumble, the AI helps you get back on track. If you give a great answer, it challenges you to make it even better.",
        faq: [
            {
