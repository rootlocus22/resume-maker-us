...
export const metadata = {
    title: 'Interview & Role Directory | InterviewGyani',
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8">
                                        {groupedRoles[char].map(role => (
                                            <div key={role.slug} className="group">
                                                <Link
                                                    href={`/interview-gyani/us/${role.slug}/interview-questions`}
                                                ...
                                                <div className="flex gap-2 text-xs text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <Link href={`/interview-gyani/us/${role.slug}/interview-questions`} className="hover:text-slate-600">US</Link>
                                                    <span className="text-slate-300">•</span>
                                                    <Link href={`/interview-gyani/uk/${role.slug}/interview-questions`} className="hover:text-slate-600">UK</Link>
                                                    <span className="text-slate-300">•</span>
                                                    <Link href={`/interview-gyani/ca/${role.slug}/interview-questions`} className="hover:text-slate-600">CA</Link>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
