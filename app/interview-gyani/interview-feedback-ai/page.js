...
export default function InterviewFeedbackPage() {
    const content = {
        ...
        solutionDescription: "With InterviewGyani, feedback is instant. After every answer, the AI breaks it down: 'Good use of metrics, but you sounded passive.' It gives you a score and a concrete way to improve immediately.",
        faq: [
            {
