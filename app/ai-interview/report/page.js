    ...
    if (!report) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50">
                <p>Something went wrong. <Link href="/ai-interview" className="text-blue-600 underline">Try again</Link></p>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-10">
                    <Link href="/ai-interview" className="text-sm font-bold text-slate-400 hover:text-slate-900 transition-colors uppercase tracking-widest flex items-center gap-2">
                ...
                <div className="bg-slate-900 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 text-white shadow-2xl mb-12 relative overflow-hidden">
                    ...
                    <div className="relative">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button
                                onClick={() => router.push('/ai-interview/setup')}
