    ...
    <div className="min-h-screen bg-gradient-to-b from-bg to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center py-12 sm:py-16 lg:py-20">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent mb-6 leading-tight">
            About ExpertResume
          </h1>
          
          <p className="text-base sm:text-lg md:text-xl lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Revolutionizing resume building with <span className="font-semibold text-accent">AI-powered tools</span> that help 
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white rounded-xl p-4 sm:p-6 text-center shadow-lg border border-border">
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-3xl font-bold text-accent mb-2">
                {stat.number}
              </div>
          ...
          <div className="p-6 sm:p-8 lg:p-12">
            <div className="lg:flex lg:items-center lg:space-x-12">
              <div className="lg:w-1/2 mb-8 lg:mb-0">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-accent text-white px-4 py-2 rounded-full text-sm font-medium mb-6">
                  <Target size={16} />
                ...
                <p className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-600 mb-6 leading-relaxed">
                  Since 2023, we've helped <span className="font-bold text-accent">thousands of professionals</span> create 
              ...
              <div className="lg:w-1/2">
                <div className="bg-gradient-to-br from-primary/5 to-accent/10 rounded-xl p-6 sm:p-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-12 mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-6 text-sm sm:text-base md:text-lg lg:text-lg text-gray-700 leading-relaxed">
              ...
              <p>
                This inspired us to assemble a team of <span className="font-semibold text-accent">HR professionals, AI experts, and designers</span> 
                to create a solution that would revolutionize how people build their resumes.
              </p>
            </div>

            <div className="mt-8 bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-primary/5 rounded-full mb-3">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-border hover:border-accent/20 group"
              >
        ...
        {/* Values Section */}
        <div className="bg-gradient-to-br from-bg to-primary/5 rounded-2xl p-6 sm:p-8 lg:p-12 mb-16">
          <div className="text-center mb-12">
                         <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl font-bold text-gray-900 mb-6">
               Our Core Values
             </h2>
        ...
        <div className="text-center py-12 sm:py-16">
          <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-8 sm:p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                href="/"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary font-semibold rounded-full hover:bg-primary/5 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
              ...
              <Link
                href="/templates"
                className="inline-flex items-center gap-2 px-8 py-4 bg-transparent text-white font-semibold rounded-full border-2 border-white hover:bg-white hover:text-primary transition-all duration-300"
              >
