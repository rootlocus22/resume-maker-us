...
export default function CareerCoachClient() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-accent-50/30 to-primary-50/30 flex items-center justify-center">
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-accent-50/30 to-primary-50/30 flex items-center justify-center p-4">
        <motion.div
        ...
        >
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-primary to-accent text-white px-6 py-3 rounded-xl hover:from-primary-800 hover:to-accent-600 transition-all duration-300 font-semibold shadow-lg"
          >
            Sign In to Continue
          </button>
        </motion.div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-accent-50/30 to-primary-50/30 flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full text-center"
        >
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary to-accent rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full bg-gradient-to-r from-primary to-accent text-white px-6 py-3 rounded-xl hover:from-primary-800 hover:to-accent-600 transition-all duration-300 font-semibold shadow-lg text-sm sm:text-base inline-flex items-center justify-center gap-2"
            >
  ...
  if (!careerPlan) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-accent-50/30 to-primary-50/30 p-4 sm:p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-primary via-primary-800 to-accent p-6 sm:p-8 text-white relative overflow-hidden">
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <div className="text-center mb-6 sm:mb-8">
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-primary to-accent rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-accent-50 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-accent/20"
                  >
                    <feature.icon className="w-6 h-6 sm:w-8 sm:h-8 text-accent mb-2" />
              ...
              <div className="text-center">
                {hasCachedPlan ? (
                  <>
                    <div className="bg-accent-50 border-2 border-accent/20 rounded-lg sm:rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center px-4 sm:px-0">
                      <button
                        ...
                        className="bg-accent hover:bg-accent-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl hover:shadow-xl transition-all duration-300 font-bold text-base sm:text-lg inline-flex items-center justify-center gap-2 sm:gap-3 w-full sm:w-auto"
                      >
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              {careerPlan.cached && (
                <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 bg-accent-50 px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl">
              ...
              <button
                onClick={() => generateCareerPlan(true)}
                disabled={generating}
                className="bg-gradient-to-r from-primary to-accent text-white px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl hover:shadow-lg transition-all duration-300 font-semibold inline-flex items-center justify-center gap-2 disabled:opacity-50 text-sm sm:text-base w-full sm:w-auto"
              >
          ...
          {isFreePlanUser() && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="mt-4 sm:mt-6 bg-accent-50 border-2 border-accent/20 rounded-lg sm:rounded-xl p-3 sm:p-4"
            >
              <div className="flex items-start gap-2 sm:gap-3">
                <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-accent flex-shrink-0 mt-0.5" />
                <div className="flex-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button
                      ...
                      className="bg-gradient-to-r from-primary to-accent text-white px-3 sm:px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300 font-semibold inline-flex items-center justify-center gap-2 text-xs sm:text-sm"
                    >
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-accent to-accent-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300 font-semibold inline-flex items-center justify-center gap-2 text-xs sm:text-sm"
                    >
                      <Crown className="w-3 h-3 sm:w-4 sm:h-4" />
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-accent-50 rounded-xl p-4">
            <p className="text-sm text-accent font-semibold mb-1">Current Level</p>
        ...
        >
          ...
          <div className="space-y-4">
            {strengths.slice(0, isFree ? 2 : strengths.length).map((strength, index) => (
              <div key={index} className="bg-accent-50 rounded-xl p-4 border border-accent/20">
        ...
        >
          ...
          <div className="space-y-4">
            {improvementAreas.slice(0, isFree ? 2 : improvementAreas.length).map((area, index) => (
              <div key={index} className="bg-primary-50 rounded-xl p-4 border border-primary/20">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600 mb-2">
                  ...
                  <span className="font-semibold text-accent">{area.targetLevel}</span>
                </div>
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-primary via-primary-800 to-accent rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 text-white"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <p className="text-white/50 text-sm font-semibold mb-2">6 Months</p>
            <p className="font-medium">{longTermVision['6MonthGoal']}</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <p className="text-white/50 text-sm font-semibold mb-2">1 Year</p>
            <p className="font-medium">{longTermVision['1YearGoal']}</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <p className="text-white/50 text-sm font-semibold mb-2">3 Years</p>
            <p className="font-medium">{longTermVision['3YearGoal']}</p>
          </div>
        </div>
        <div className="mt-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl">
          <p className="text-white/50 text-sm font-semibold mb-2">Career Path</p>
