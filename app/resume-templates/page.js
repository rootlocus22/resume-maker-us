...
const getCategoryColor = (category) => {
  const colors = {
    ...
    "Tech": "from-indigo-600 to-indigo-800",
...
export default function TemplatesPage() {
  ...
  if (isLoading) {
    return (
      <div className="templates-page min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          {/* Loading Hero */}
          <div className="text-center mb-12 sm:mb-16">
            <div className="animate-pulse">
              <div className="h-5 sm:h-6 bg-gradient-to-r from-blue-200 to-blue-200 rounded-full w-24 sm:w-32 mx-auto mb-4 sm:mb-6"></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
            {[...Array(10)].map((_, i) => (
              <div key={i} className="group animate-pulse">
                <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500">
  ...
  if (error) {
    return (
      <div className="templates-page min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-red-100 p-6 sm:p-8 text-center">
          ...
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl hover:from-blue-700 hover:to-blue-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 w-full sm:w-auto"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="templates-page min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-3 px-4 text-center text-sm font-medium">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center py-8 sm:py-12 lg:py-16 relative">
          {/* Background Elements */}
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/3 w-full max-w-4xl h-32 sm:h-48 lg:h-64 bg-gradient-to-r from-blue-500/10 to-purple-500/10 blur-3xl rounded-full z-0"></div>

          <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-md border border-blue-200/50 rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-4 sm:mb-6 shadow-lg relative z-10">
            <Sparkles className="text-blue-600 w-4 h-4 sm:w-5 sm:h-5" />
            <span className="text-blue-700 font-semibold text-xs sm:text-sm">World-Class Templates</span>
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-6 sm:mb-8 relative z-10 px-4">
            ...
            <span className="font-semibold text-blue-600"> Create stunning resumes in minutes.</span>
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 max-w-4xl mx-auto mb-6 sm:mb-8 relative z-10 px-4">
            <div className="text-center bg-white/80 backdrop-blur-sm p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-gray-200/50 shadow-sm">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-600 mb-1">{templates.length}+</div>
              <div className="text-gray-600 font-medium text-xs sm:text-sm lg:text-base">Premium Templates</div>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-gray-200/50 shadow-sm">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-600 mb-1">50K+</div>
              <div className="text-gray-600 font-medium text-xs sm:text-sm lg:text-base">Resumes Created</div>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-gray-200/50 shadow-sm">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-600 mb-1">95%</div>
              <div className="text-gray-600 font-medium text-xs sm:text-sm lg:text-base">Success Rate</div>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-gray-200/50 shadow-sm">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-600 mb-1">24/7</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center">
                ...
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 border border-gray-200 rounded-xl sm:rounded-2xl text-sm sm:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                  />
                  {searchTerm && (
                    <button
                      onClick={() => {
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border border-gray-200 rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3 sm:py-4 pr-8 sm:pr-10 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 cursor-pointer"
                  >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {popularTerms.map((term) => (
                      <button
                        ...
                        className="px-3 py-1.5 bg-gradient-to-r from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 text-blue-700 rounded-full text-xs font-medium transition-all duration-200 border border-blue-200 hover:border-blue-300"
                      >
                        {term}
                      </button>
                    ))}
          ...
          <div className="max-w-4xl mx-auto mb-8 px-4">
            <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-cyan-600 rounded-3xl p-1 shadow-2xl">
              <div className="bg-white rounded-[22px] p-6 sm:p-8">
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-cyan-50 px-4 py-2 rounded-full mb-4">
                    ...
                    <span className="text-blue-700 font-semibold text-sm">NEW: Smart Template Finder</span>
                  </div>
                  <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
                    Not sure which template to choose?
                  </h3>
                  <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                    Answer <span className="font-semibold text-blue-600">5 quick questions</span> and we'll recommend the perfect templates for your experience level, industry, and goals. Takes just 60 seconds!
                  </p>
                  <button
                    onClick={() => setShowDiscovery(true)}
                    className="bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 mx-auto group"
                  >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center relative z-10 px-4">
            <Link href="#templates">
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 w-full sm:w-auto">
        ...
        <div id="templates">
          {filteredTemplates.length > 0 ? (
            ...
            <div className="text-center py-16 sm:py-24">
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-12 max-w-lg mx-auto">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl hover:from-blue-700 hover:to-blue-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Clear all filters
                </button>
              </div>
        ...
        <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 mb-12 sm:mb-16 border border-gray-200/50">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-8 sm:mb-12 bg-gradient-to-r from-slate-800 to-blue-800 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="w-10 sm:w-12 h-10 sm:h-12 bg-blue-100 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="w-10 sm:w-12 h-10 sm:h-12 bg-purple-100 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
        ...
        <div className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 rounded-2xl sm:rounded-3xl lg:rounded-[3rem] p-6 sm:p-8 lg:p-12 xl:p-16 text-center text-white shadow-2xl mb-12 sm:mb-16 overflow-hidden">
          {/* Background Effects */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-purple-600/20"></div>
          <div className="absolute top-0 left-1/4 w-48 sm:w-64 lg:w-96 h-48 sm:h-64 lg:h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-48 sm:w-64 lg:w-96 h-48 sm:h-64 lg:h-96 bg-purple-500/10 rounded-full blur-3xl"></div>
          ...
          <div className="relative z-10">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
            ...
            <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 opacity-70">
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-blue-200">User Rating</div>
              </div>
              <div className="hidden sm:block w-px h-8 bg-white/20"></div>
              <div className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-blue-400">ATS</div>
                <div className="text-xs sm:text-sm text-blue-200">Optimized</div>
              </div>
              <div className="hidden sm:block w-px h-8 bg-white/20"></div>
              <div className="text-center">
              ...
              <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                ...
                <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <Link href={getBuilderUrl(previewModal.id, previewModal)} className="flex-1">
                    <button
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-600 text-white py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold hover:from-blue-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-sm sm:text-base"
...
function TemplateCard({ template, hoveredTemplate, onHover, onClick, getBuilderUrl, setPreviewModal, isMobile, showCategoryBadge = false }) {
  return (
    <div
      className="group relative bg-white rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl hover:border-gray-200 transition-all duration-500 transform hover:scale-[1.02] cursor-pointer template-card"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end">
            <div className="p-4 sm:p-6 w-full space-y-2 sm:space-y-3">
              ...
              <Link href={getBuilderUrl(template.id, template)} className="block">
                <button
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-600 text-white py-2 sm:py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 hover:from-blue-700 hover:to-blue-700 transition-all shadow-lg"
                  onClick={(e) => {
                    e.stopPropagation();
                    onClick(template.id);
                  }}
      ...
      <div className="p-4 sm:p-6">
        <div className="mb-3 sm:mb-4">
          <Link href={`/resume-templates/${template.id}`} className="block">
            <h3 className="text-base sm:text-lg font-bold text-gray-900 group-hover:text-blue-700 transition-colors mb-2 line-clamp-2 leading-tight">
              {template.name}
            </h3>
          </Link>
        ...
        {isMobile && (
          <div className="space-y-2">
            ...
            <Link href={getBuilderUrl(template.id, template)} className="block" rel="nofollow">
              <button
                className="w-full bg-gradient-to-r from-blue-600 to-blue-600 text-white py-2.5 sm:py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 hover:from-blue-700 hover:to-blue-700 transition-all shadow-lg"
                onClick={(e) => {
                  e.stopPropagation();
                  onClick(template.id);
                }}
        ...
        {!isMobile && (
          <div className="flex items-center gap-3">
            ...
            <Link href={getBuilderUrl(template.id, template)} rel="nofollow">
              <button
                className="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-2 hover:gap-3 transition-all group/button"
                onClick={(e) => {
                  e.stopPropagation();
                  onClick(template.id);
                }}
