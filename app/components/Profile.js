  ...
  return (
    <div className={`mt-8 ${className}`}>
      <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
        {icon && React.cloneElement(icon, { className: 'mr-3 text-[#0B1F3B]', size: 20 })}
        {title}
      </h3>
      <div className="space-y-6">
        {validItems.map((item, index) => (
          <div key={index} className="pl-8 relative before:absolute before:left-4 before:top-0 before:h-full before:w-px before:bg-gray-200 before:content-[''] first:before:h-[calc(100%-24px)] first:before:top-6 last:before:h-6">
            <div className="relative before:absolute before:-left-8 before:top-2 before:h-3 before:w-3 before:rounded-full before:border-4 before:border-[#0B1F3B] before:content-['']">
              {renderItem(item)}
            </div>
          </div>
        ))}
...
const getSkillColor = (index, proficiency) => {
  const colors = [
    'bg-slate-100 text-[#0B1F3B] border-slate-200',
    'bg-slate-100 text-[#0B1F3B] border-slate-200',
    'bg-slate-100 text-[#0B1F3B] border-slate-200',
    'bg-slate-100 text-[#0B1F3B] border-slate-200',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="flex flex-col items-center">
          <div className="animate-spin rounded-full h-12 w-12 border-4 border-[#0B1F3B] border-t-transparent mb-4" />
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-lg text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-[#0B1F3B] to-[#0B1F3B] text-white px-6 py-3 rounded-lg hover:from-[#071429] hover:to-[#071429] transition-all font-semibold flex items-center justify-center gap-2"
            >
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-lg text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              onClick={() => router.push('/edit-profile')}
              className="flex-1 border-2 border-[#0B1F3B] text-[#0B1F3B] px-6 py-3 rounded-lg hover:bg-slate-50 transition-all font-semibold flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
              </svg>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md mx-4 animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-[#0B1F3B] to-[#0B1F3B] bg-clip-text text-transparent">
                  Share Profile
                </h3>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-[#0B1F3B] to-[#0B1F3B] text-white rounded-xl hover:from-[#071429] hover:to-[#071429] transition-all duration-200 shadow-lg hover:shadow-xl font-medium flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
                >
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <a
                  ...
                  className="flex flex-col items-center justify-center p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 transition-all duration-200 group hover:scale-105 active:scale-95"
                >
                  ...
                  <span className="mt-2 text-xs font-medium text-[#0B1F3B]">LinkedIn</span>
                </a>
                ...
                >
                  ...
                  <span className="mt-2 text-xs font-medium text-[#0B1F3B]">Facebook</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center p-4 rounded-xl bg-gradient-to-br from-blue-50 to-emerald-100 hover:from-blue-100 hover:to-emerald-200 transition-all duration-200 group hover:scale-105 active:scale-95"
                >
                  ...
                  <span className="mt-2 text-xs font-medium text-[#0B1F3B]">WhatsApp</span>
                </a>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="relative h-32 bg-gradient-to-r from-[#0B1F3B] to-[#00C4B3]">
              ...
              <div className="pt-20 pb-6 px-6 text-center">
                ...
                {(emailVerified || phoneVerified) && (
                  <div className="flex justify-center space-x-2 mb-4">
                    {emailVerified && (
                      <span className="inline-flex items-center bg-slate-100 text-blue-800 px-2 py-1 rounded-full text-xs font-medium">
              ...
              {(email || phone || website) && (
                <div className="p-6 border-t border-gray-200">
                  ...
                  <ul className="space-y-3">
                    {email && (
                      <li>
                        <a href={`mailto:${email}`} className="flex items-center text-gray-600 hover:text-[#0B1F3B] transition-colors">
                    ...
                    {phone && (
                      <li>
                        <a href={`tel:${phone}`} className="flex items-center text-gray-600 hover:text-[#0B1F3B] transition-colors">
                    ...
                    {website && (
                      <li>
                        <a href={ensureAbsoluteUrl(website)} target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-[#0B1F3B] transition-colors">
              ...
              {hasSkills && (
                <div className="p-6 border-t border-gray-200">
                  ...
                  {userSkills.length > 8 && (
                    <button className="mt-3 text-[#0B1F3B] text-sm font-medium hover:underline" onClick={() => setActiveTab('skills')}>
                ...
                <div className="flex space-x-4">
                  {linkedin && (
                    <a href={ensureAbsoluteUrl(linkedin)} target="_blank" rel="noopener noreferrer" className="bg-slate-100 p-3 rounded-lg hover:bg-slate-200 transition-colors">
                      <LinkedInIcon className="w-5 h-5 text-[#0B1F3B]" />
                    </a>
                  )}
                  {github && (
          ...
          <div className="lg:w-2/3">
                  ...
                  {tabs.map(tab => (
                    <button
                      ...
                      className={`px-6 py-4 font-medium text-sm whitespace-nowrap ${activeTab === tab.id
                          ? 'text-[#0B1F3B] border-b-2 border-[#0B1F3B]'
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden p-8">
                        ...
                        <div className="pb-6">
                          <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                            <div className="flex-1">
                              ...
                              <p className="text-lg text-[#0B1F3B]">{exp.company}</p>
                              {exp.location && (
                        ...
                        <div className="pb-6">
                          <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                            <div className="flex-1">
                              ...
                              <p className="text-lg text-[#0B1F3B]">{edu.degree}</p>
                              {edu.fieldOfStudy && (
                  ...
                  {hasSkills && (
                    <div className="mb-10">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                        <Star size={20} className="mr-3 text-[#0B1F3B]" /> Skills
                      </h3>
                        ...
                        <div className="pb-6">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <p className="text-lg text-[#0B1F3B]">{cert.issuer}</p>
                            </div>
                            {cert.date && (
                          ...
                          {cert.url && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center text-[#0B1F3B] hover:text-[#071429] text-sm mt-2"
                            >
                        ...
                        <div className="pb-6">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              {project.company && (
                                <p className="text-lg text-[#0B1F3B]">{project.company}</p>
                              )}
                            </div>
              ...
              {activeTab === 'skills' && hasSkills && (
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                    <Star size={20} className="mr-3 text-[#0B1F3B]" /> Skills & Expertise
                  </h3>
                  <div className="space-y-6">
                    ...
                    <div className="pb-6">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          {pub.publisher && (
                            <p className="text-lg text-[#0B1F3B]">{pub.publisher}</p>
                          )}
                        </div>
                        {pub.date && (
                    ...
                    <div className="pb-6">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-lg text-[#0B1F3B]">{vol.organization}</p>
                        </div>
              ...
              {!hasAbout && !hasExperience && !hasEducation && !hasSkills && !hasCertifications && !hasProjects && !hasPublications && !hasVolunteer && (
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={() => router.push('/edit-profile')}
                    className="bg-[#0B1F3B] text-white px-6 py-2 rounded-lg hover:bg-[#071429] transition-colors"
                  >
                    Edit Profile
                  </button>
                </div>
