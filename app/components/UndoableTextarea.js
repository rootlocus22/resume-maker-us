...
const UndoableTextarea = ({ 
  ...
  return (
    <div className={`relative border border-gray-300 rounded-md shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 ${className}`}>
      {showToolbar && (
