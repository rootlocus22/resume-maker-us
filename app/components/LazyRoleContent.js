    ...
    return (
        <>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border-2 border-blue-200">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <div className="bg-white rounded-xl p-6 border-l-4 border-blue-600 shadow-sm relative">
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-white rounded-2xl p-8 border-2 border-indigo-100 shadow-xl relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-center relative">
                                ...
                                {role.career_path.map((step, index) => (
                                    <div key={index} className="flex flex-col items-center mb-8 md:mb-0 relative group">
                                        <div className="w-12 h-12 rounded-full bg-white border-4 border-blue-600 flex items-center justify-center mb-4 shadow-md group-hover:scale-110 transition-transform">
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border-2 border-blue-200">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {role.hard_skills.map((skill, index) => (
                                    <span
                                        key={index}
                                        className="bg-white text-blue-700 px-4 py-2 rounded-full text-sm font-semibold border border-blue-200 shadow-sm hover:shadow-md transition-shadow"
                                    >
                                        {renderSafe(skill)}
                                    </span>
                                ))}
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {(role.salary_data.india_average || role.salary_data.uk_average || role.salary_data.us_average) && (
                            <div className="mb-12">
                                ...
                                <div className="grid md:grid-cols-4 gap-4 max-w-6xl mx-auto">
                                    ...
                                    <div className="bg-white rounded-xl p-6 border-2 border-blue-300 text-center hover:shadow-lg transition-shadow">
                                        <div className="text-sm font-semibold text-blue-700 mb-2">Mid-Level</div>
                        ...
                        {role.salary_data.location_specific && (
                            <div className="mb-12 bg-white rounded-2xl p-8 max-w-4xl mx-auto shadow-lg border border-gray-200">
                                ...
                                <div className="text-center">
                                    <div className="text-3xl font-bold text-indigo-900">{role.salary_data.location_specific.average}</div>
                                ...
                                <div className="grid md:grid-cols-5 gap-4 max-w-6xl mx-auto">
                                    {Object.entries(role.salary_data.top_companies).map(([company, salary]) => (
                                        <div key={company} className="bg-white rounded-lg p-4 border border-gray-200 text-center hover:shadow-md transition-shadow">
                                            ...
                                            <div className="text-lg font-bold text-indigo-900">{salary}</div>
                                        </div>
                                    ))}
                                </div>
                ...
                <section className="py-16 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                            ...
                            <div className="bg-blue-50 rounded-xl p-6 border-2 border-blue-500 transform scale-105 shadow-lg text-center relative">
                                <div className="absolute top-0 right-0 bg-blue-600 text-white text-xs px-2 py-1 rounded-bl-lg font-bold">AVG</div>
                                <div className="text-lg font-semibold text-blue-800 mb-2">Mid Level</div>
                                <div className="text-3xl font-bold text-blue-900">{role.salary_breakdown.mid}</div>
                                <div className="text-sm text-blue-600 mt-2">3-8 Years</div>
                            </div>
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="space-y-6">
                            {role.interview_questions.map((qa, index) => (
                                <div key={index} className="bg-white rounded-xl p-6 shadow-md border-l-4 border-indigo-500">
                                    ...
                                    <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-100">
                                        <div className="text-sm font-semibold text-indigo-900 mb-2">💡 Expected Answer:</div>
                                ...
                                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border-2 border-blue-200">
                                    ...
                                    <div className="space-y-3">
                                        {role.skills_matrix.technical.map((skill, idx) => (
                                            <div key={idx} className="bg-white rounded-lg p-3 shadow-sm">
                                                <div className="font-semibold text-gray-900">{skill.name}</div>
                                                <div className="text-xs text-blue-600 font-semibold mt-1">{skill.importance}</div>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-blue-50 rounded-xl p-6 shadow-sm border border-blue-200">
                            <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                                <span className="text-blue-600">Bot Question:</span> Is this resume format ATS-friendly?
                            </h3>
                            <p className="text-gray-700 leading-relaxed">
                        ...
                        <div className="bg-blue-50 rounded-xl p-6 shadow-sm border border-blue-200">
                            <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                                <span className="text-blue-600">Bot Question:</span> Can I use this {renderSafe(role.job_title)} format for international jobs?
                            </h3>
                            <p className="text-gray-700 leading-relaxed">
            ...
            <section className="py-20 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <Link
                            href="/resume-builder"
                            className="group bg-white text-blue-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-yellow-300 hover:text-blue-700 transition-all duration-300 shadow-2xl hover:shadow-yellow-300/50 flex items-center gap-2"
                        >
