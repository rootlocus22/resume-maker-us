    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden animate-pulse">
            <div className="p-8 md:p-12 text-center border-b border-gray-100">
                ...
                <div className="bg-blue-50/50 border-2 border-dashed border-blue-200 rounded-xl p-10 flex flex-col items-center justify-center max-w-2xl mx-auto space-y-6">
                    ...
                    <div className="h-12 bg-blue-100 rounded-full w-48 mt-4"></div>
                </div>
